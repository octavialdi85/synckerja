...
import { useIncomeTransactionDashboardStats } from "./hooks/useIncomeTransactionDashboardStats";
import { IncomeTransactionDashboardCarousel } from "./section/IncomeTransactionDashboardCarousel";
import { IncomeTransactionTableSection } from "./section/IncomeTransactionTableSection";
...
export default function IncomeTransactionPage() {
  ...
  } = useIncomeTransactionDashboardStats();
        ...
        <div className="min-h-screen flex w-full bg-background">
          ...
          <main className="flex flex-col bg-background fixed inset-x-0 z-0" style={mainFixedStyle}>
            ...
            >
              ...
              <IncomeTransactionDashboardCarousel
                isLoading={isLoading}
