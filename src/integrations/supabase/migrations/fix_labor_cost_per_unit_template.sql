-- Fix: Update template - semua labor cost adalah per unit (tidak ada checkbox isForTotalBatch)
-- Labor cost: rate × quantity = cost per unit
-- Untuk parfum yang realistis: jika rate 20.000/jam dan 1 botol butuh 0.02 jam (1.2 menit), cost = 400 per unit

-- Perhitungan yang realistis per unit:
-- Raw Materials per unit: 12.000 + 7.000 = 19.000
-- Labor per unit: 20.000/jam × 0.02 jam = 400 (1.2 menit per botol untuk mixing/filling)
