...
const PublicContentReviewPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col overflow-x-hidden">
      ...
      <div className="flex-1 flex flex-col w-full md:max-w-2xl md:mx-auto md:px-6 lg:px-8">
        {/* Header / metadata */}
        <div className="w-full px-4 pt-4 pb-2 md:px-0">
        ...
        {/* Preview - full width on mobile, contained on desktop */}
        {(() => {
          ...
          const aspectClass = portrait
            ...
            : 'aspect-video w-full';
          return (
            <div className="w-full bg-white border-y border-gray-200 shadow-sm md:rounded-xl md:border md:border-gray-200 md:shadow-sm flex flex-col flex-shrink-0 overflow-hidden">
              ...
              <div className={`w-full flex items-center justify-center bg-black/5 min-h-0 ${portrait ? 'flex' : ''}`}>
                {!link ? (
                  <div className="py-12 text-center text-gray-500 text-sm w-full">Tidak ada link</div>
                ) : isFolderLink(link) ? (
                  ...
                  <div className={`w-full overflow-hidden bg-black ${aspectClass}`}>
                    <iframe
                      src={embedUrl}
        ...
        {/* Comments - full width on mobile, contained on desktop */}
        <div className="w-full bg-white md:rounded-xl md:border md:border-gray-200 md:shadow-sm border-y border-gray-200 shadow-sm flex flex-col flex-shrink-0 mt-0">
          <div className="w-full border-b border-gray-100 bg-gray-50 flex-shrink-0">
            ...
            <div className="w-full px-4 sm:px-6 py-4 space-y-4">
              {comments.length === 0 ? (
                ...
                <ul className="space-y-4 list-none p-0 m-0">
                  {comments.map((c) => (
                    <li key={c.id} className="border-b border-gray-100 pb-4 last:border-0 last:pb-0">
                      <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-gray-600 mb-1.5">
          ...
          <div className="w-full border-t border-gray-200 bg-gray-50/50 flex-shrink-0">
