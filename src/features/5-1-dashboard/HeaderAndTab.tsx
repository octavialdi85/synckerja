...
export const HeaderAndTab = ({ activeTab, onTabChange }: HeaderAndTabProps) => {
  ...
  const tabs = [
    ...
    },
    {
      ...
      route: '/operations/customer-service/tickets'
    }
  ];
  ...
  return (
    <div className="px-1 py-3">
      {/* Header Section */}
      <div className="mb-3">
        <h1 className="text-xl font-bold text-gray-900 mb-0.5">Customer Service</h1>
        <p className="text-xs text-gray-600">Manage customer service tickets and support</p>
      </div>
