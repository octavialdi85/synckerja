...
interface DialogContentProps extends React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> {
  /** @deprecated Close button has been removed; prop kept for backward compatibility */
  hideCloseButton?: boolean;
  overlayClassName?: string;
  /** Use fullscreen-style animation (slide up + scale) for modals that occupy full viewport */
...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, hideCloseButton: _hideCloseButton, overlayClassName, fullscreenAnimation = false, ...props }, ref) => (
  <DialogPortal>
