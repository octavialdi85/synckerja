...
export const HeaderAndTab = ({ activeTab, onTabChange }: HeaderAndTabProps) => {
  ...
  return (
    <div className="px-1 py-3">
      {/* Header Section */}
      <div className="mb-3">
        <h1 className="text-xl font-bold text-gray-900 mb-0.5">Income Management</h1>
        <p className="text-xs text-gray-600">Manage income transactions, analytics, and financial records</p>
      </div>
