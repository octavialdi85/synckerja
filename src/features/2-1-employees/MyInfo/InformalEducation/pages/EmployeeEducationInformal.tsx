...
import { InformalEducationInfoTab } from '../components/employee-detail/InformalEducationInfoTab';
import { useEmployeeDetail } from '../../InformalEducation/hooks/useEmployeeDetail';
import { useAvatarSync } from '../../InformalEducation/hooks/useAvatarSync';
import { toast } from 'sonner';
import { InformalEducationTableFooter } from '../components/InformalEducationTableFooter';
import { InformalEducationSidebarFooter } from '../components/InformalEducationSidebarFooter';

const EmployeeEducationInformal = () => {
                        ...
                        <div className="flex-1 overflow-y-auto seamless-scroll min-h-0">
                          <div className="p-6">
                            ...
                            <div className="flex items-center justify-between mb-6">
                              <h2 className="text-xl font-semibold text-gray-900">Informal Education</h2>
                            </div>
                            
                            <InformalEducationInfoTab employee={employee} isEditMode={isEditMode} onUpdate={() => {}} />
                          </div>
                        </div>
...
export default EmployeeEducationInformal;
