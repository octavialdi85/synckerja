...
import { DocumentsInfoTab } from '../components/employee-detail/DocumentsInfoTab';
import { useEmployeeDetail } from '../../Documents/hooks/useEmployeeDetail';
import { useAvatarSync } from '../../Documents/hooks/useAvatarSync';
import { toast } from 'sonner';
import { DocumentsTableFooter } from '../components/DocumentsTableFooter';
import { DocumentsSidebarFooter } from '../components/DocumentsSidebarFooter';
...
const EmployeeDocuments = () => {
  ...
  const isEditMode = true; // Always allow editing documents
  ...
  // Calculate document count (this is a placeholder, can be calculated from actual data)
  const documentCount = 8; // This should come from actual document data
  
  // Calculate total documents (placeholder)
  const totalDocuments = 8; // This should be calculated from document list
                      ...
                      <div className="bg-white rounded-lg border border-gray-200 shadow-sm flex flex-col h-full">
                        <div className="flex-1 overflow-y-auto seamless-scroll min-h-0">
                          <div className="p-6">
                            ...
                            <DocumentsInfoTab employee={employee} isEditMode={isEditMode} onUpdate={() => {}} />
                          </div>
                        </div>
