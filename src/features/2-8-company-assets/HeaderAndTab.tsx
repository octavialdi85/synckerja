...
// HeaderAndTab for Company Assets page only - independent from other tabs
export const HeaderAndTab = ({ activeTab, onTabChange }: HeaderAndTabProps) => {
  ...
  return (
    <div className="py-3 pl-2 ml-0 company-assets-header-tab-wrapper">
      {/* Header Section */}
      <div className="mb-3">
...
HeaderAndTab.displayName = 'CompanyAssetsHeaderAndTab';
