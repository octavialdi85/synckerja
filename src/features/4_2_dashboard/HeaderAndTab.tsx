  ...
  return (
    <div className="px-1 py-3 min-w-0">
      ...
      <div className="mb-3 min-w-0">
        <h1 className="text-lg sm:text-xl font-bold text-gray-900 mb-0.5 truncate">Expense Management</h1>
        <p className="text-xs text-gray-600 truncate">Manage expense transactions, analytics, and financial records</p>
      </div>

      {/* Tabs Section */}
      <div className="-mb-3 min-w-0">
        <nav className="flex space-x-2 sm:space-x-6 overflow-x-auto seamless-scroll min-w-0">
          {tabs.map((tab) => {
            const Icon = tab.icon;
            ...
            return (
              <div
                ...
                className={`flex items-center space-x-1 sm:space-x-1.5 py-1.5 px-1 sm:px-2 border-b-2 font-medium text-xs sm:text-sm cursor-pointer transition-colors whitespace-nowrap flex-shrink-0 min-w-0 ${
                  isActive
