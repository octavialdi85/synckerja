...
export const HeaderAndTab = ({ activeTab, onTabChange }: HeaderAndTabProps) => {
  ...
  const tabs = [
    {
      ...
      description: 'View subscription overview and analytics',
      route: '/subscription'
    },
    {
      id: 'plans',
  ...
  return (
    <div className="px-1 py-3">
      {/* Header Section */}
      <div className="mb-3">
        <h1 className="text-xl font-bold text-gray-900 mb-0.5">Subscription Management</h1>
        <p className="text-xs text-gray-600">Manage your subscription, billing, and account settings</p>
      </div>
