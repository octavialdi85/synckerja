...
import ReimbursementRequestForm from '@/components/1_halaman/9_request-form/components/ReimbursementRequestForm';
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col min-w-0 bg-background">
            ...
            <div className="bg-card border-b border-border px-3 py-2">
              ...
              {/* Compact Tabs */}
              <Tabs value="reimbursement" onValueChange={handleTabChange}>
