...
export const ReprimandManagementMain = () => {
  ...
  return (
    <div className="h-full flex flex-col max-h-[calc(100vh-200px)]">
      ...
      <div className="flex-1 min-h-0">
        <div className="h-full bg-white rounded-lg border border-gray-200 shadow-sm flex flex-col seamless-scroll max-h-[calc(100vh-120px)]">
