...
export const RegistrationForm = (props: RegistrationFormKeyboardProps) => {
  ...
  return <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button ref={submitButtonRef} type="submit" className="w-full h-12 rounded-md bg-orange-500 hover:bg-orange-600 text-white font-medium mt-6" disabled={loading}>
