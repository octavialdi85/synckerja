-- Notify the person who was unassigned when a step or sub-step is unassigned (DELETE).
-- Step unassign: DELETE from task_steps_assigned
-- Sub-step unassign: DELETE from task_steps_to_steps_assigned

-- Trigger: task_steps_assigned DELETE
...
-- Trigger: task_steps_to_steps_assigned DELETE
