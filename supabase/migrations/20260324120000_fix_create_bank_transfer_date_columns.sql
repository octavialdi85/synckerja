-- create_bank_transfer used to_char(p_transaction_date, 'YYYY-MM-DD') for DATE columns;
-- PostgreSQL rejects assigning text to date without cast. Use p_transaction_date directly.
...
BEGIN
  ...
  -- Lock / ensure source balance row (per org)
