...
-- Migrate existing rows: whatsapp_conversation_follow_up_updates -> lead_status_history.
-- Map: update_details -> notes, status -> new_status, created_at -> changed_at/created_at, created_by/created_by_name -> changed_by/changed_by_name.
